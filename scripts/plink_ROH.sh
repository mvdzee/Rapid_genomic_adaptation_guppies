...
# It requires phased vcfs!

### set the variables
DIR=/gpfs/ts0/home/mv323/lustre/start_up_data/people/mijke/STAR_analyses/FIBR/phased_vcfs/outputs
OUT=/gpfs/ts0/home/mv323/lustre/start_up_data/people/mijke/STAR_analyses/FIBR/ROH
...
~/lustre/bin/plink --vcf $DIR/GL_phased_autosomes.recode.vcf.gz --homozyg-snp 622 --homozyg-kb 500 --homozyg-density 50 --homozyg-gap 1000 --homozyg-window-snp 50 --homozyg-window-het 1 --homozyg-window-missing 5 --homozyg-window-threshold 0.05 --out $OUT/GLP_500K_1het --allow-extra-chr
